...
<div class="container sectin3 my-2">
    ...
    <div class="row categoryHead">
        <div class="col-sm-12 text-center my-2">
            <h2 class="display-4 fs-2 fw-bold">Category wise Posts</h2>
        </div>
    </div>
    <!-- S3-Row blogs Heading -->
    <?php
...
<?php
          ...
          if ($_GET['page'] > 0) {
            ?>
              <a href="view_category.php?category_id=<?=$category_id?>&page=<?php echo $_GET['page']-1;?>">Previous</a>
            <?php
          }
          ...
          for ($i=1; $i <=$total_pages; $i++) { 
            ...
            ?>
             <a style="color:red;font-size :24px; padding:5px; text-decoration:none;" href="view_category.php?category_id=<?=$category_id?>&page=<?php echo $i-1; ?>"><?php echo $i;?></a>
            <?php
            }else{
                ?>
                 <a style="font-size :24px; padding:5px; text-decoration:none;" href="view_category.php?category_id=<?=$category_id?>&page=<?php echo $i-1; ?>"><?php echo $i;?></a>
                <?php
            }
          }
          ...
          if ($_GET['page'] < $total_pages-1) {
            ?>
              <a href="view_category.php?category_id=<?=$category_id?>&page=<?php echo $_GET['page']+1;?>">Next</a>
            <?php
          }
...
<div class="container section4 my-3" id="posts">
    ...
    <div class="row cards my-1 text-start gy-2">
        ...
        $query="  SELECT * FROM post p
                    ...
                    and (b.blog_status='Active'&& p.post_status='Active')       

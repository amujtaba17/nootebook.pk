        ...
        <div class="col-sm-9 mx-5 my-3">
            <div class="row">
                <div class="col-sm-12 text-center">
                    <h2 class="display-4 fs-2"> All Users </h2>
                </div>
                ...
                <div class="col-sm-12 px-0 mx-2">
                    <table class="table table-bordered" id="example">
                        ...
                        <tbody>
                            <?php 
                            $count=1;
                            $query="SELECT * FROM USER where is_approved='Approved' AND  role_id=2 ORDER BY (user_id) DESC ";
                            ...
                            <tr>
                                ...
                                <td><?=$address?></td>
                                <td class="fw-bold <?=$is_active=='Active'?"text-success":"text-danger"?>"><?=$is_active?></td>
                                <td>
                                    <?php if($is_active==='InActive'){
                                        ?>
                                    <a href="admin_user_processes.php?user_id=<?=$user_id?>&action=active"
                                        class="btn btn-outline-success my-1">Active</a>

                                    <?php
                                    }elseif($is_active==='Active'){
                                        ?>
                                    <a href="admin_user_processes.php?user_id=<?=$user_id?>&action=deactive"
                                        class="btn btn-outline-warning my-1">InActive</a>
                                    <?php
                                    }
                                    ?>

                                    <a href="admin_add_user.php?user_id=<?=$user_id?> "
                                        class="text-decoration-none btn btn-outline-info">Update</a>
                                </td>
